...
export default function ProjectsModal({projectIndex}: ProjectsModalProps) {
  ...
  return (
    <>
      ...
      />
      <div className="absolute bottom-0 text-4xl flex justify-center items-center right-0 bg-[#CFD3D6] m-2 p-1 rounded-full lg:hidden">
        <AddIcon onClick={() => openModalWithIndex()} className="text-4xl text-gray-three animate-pulse ease-in-out duration-1000" />
      </div>
      <Modal
        size="xl"
